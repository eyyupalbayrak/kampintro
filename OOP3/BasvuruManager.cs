...
namespace OOP3
{
    class BasvuruManager
    {
        ...
        public void BasvuruYap(KrediManager krediManager, List<ILoggerService> loggerServices) // Birden çok log çağırmak için
        {
        ...
        public void KrediOnBilgilendirmesiYap(List<KrediManager> krediler) // IKrediManager türünde liste eklenir
        {
